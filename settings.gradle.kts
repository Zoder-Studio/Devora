...
include(":vendor:terminal-emulator")
project(":vendor:terminal-emulator").projectDir = file("vendor/termux-app/terminal-emulator")
include(":vendor:terminal-view")
project(":vendor:terminal-view").projectDir = file("vendor/termux-app/terminal-view")